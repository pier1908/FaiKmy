...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'DESKTOPWIN\t5.5.1.1.1590\tWINDOWS_NT\t8.'}    
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
              'X-Line-Application': 'DESKTOPWIN\t5.5.1.1.1590\tWINDOWS_NT\t8.', 
  ...
  def loginResult(self, callback=True):
    if callback is True:
      ...
      print("===============[F41 Selfbot]================")
      print("       Salam From Anak KEMAYORAN ")
      print("===============[BY F41 KEMAYORAN]================")
      print("mid -> " + prof.mid)
